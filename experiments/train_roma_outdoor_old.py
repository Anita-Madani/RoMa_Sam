...
def get_model(pretrained_backbone=True, resolution = "medium", **kwargs):
    ...
    proj16 = nn.Sequential(nn.Conv2d(256, 512, 1, 1), nn.BatchNorm2d(512))
...
#    ),
#    amp=True,
#    use_vgg=False  # 👈 You can toggle this based on your preference
#    )
...
def train(args):
    ...
    checkpoint_dir = "/cis/net/io104/data/smadani4/checkpoint_SaM"
    h,w = resolutions[resolution]
    ...
    N = 40625  # 250k steps of batch size 32
    # checkpoint every
    k = 40625

    # Data
    mega = MegadepthBuilder(data_root="/cis/net/io99a/data/challenge-datasets/data/megadepth", loftr_ignore=True, imc21_ignore = True)
    ...
    megadense_benchmark = MegadepthDenseBenchmark("/cis/net/io99a/data/challenge-datasets/data/megadepth", num_samples = 1000, h=h,w=w)
